# This code was brought from scikit-learn and modified to be applicable to our approach
...
def export_graphviz(decision_tree, out_file=None, max_depth=None,
                    ...
                    rounded=False, special_characters=False, precision=3, class_identity = None):
    ...
    def node_to_str(tree, node_id, criterion):
        ...
        # Write class identity of this filter
        if (class_identity is not None and
           tree.children_left[node_id] != _tree.TREE_LEAF):
            ci_string = "CT = %s%s" % (class_identity[tree.feature[node_id]], characters[4])
            node_string += ci_string
